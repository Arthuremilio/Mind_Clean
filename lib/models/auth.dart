...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(String email, String password, String urlFragment,
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlFragment?key=ChaveDoBanco';
  ...
  Future<void> resetPassword(String email) async {
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=ChaveDoBanco';
